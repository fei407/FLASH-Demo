...
GIF_DIR = os.path.join(SCRIPT_DIR, "output", "gif")

gif_pairs = [
    (os.path.join(GIF_DIR, "1_base.gif"), os.path.join(GIF_DIR, "1_ft.gif")),
    (os.path.join(GIF_DIR, "2_base.gif"), os.path.join(GIF_DIR, "2_ft.gif")),
    (os.path.join(GIF_DIR, "3_base.gif"), os.path.join(GIF_DIR, "3_ft.gif")),
    (os.path.join(GIF_DIR, "4_base.gif"), os.path.join(GIF_DIR, "4_ft.gif")),
]
